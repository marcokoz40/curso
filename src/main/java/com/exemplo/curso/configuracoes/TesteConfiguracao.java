...
public class TesteConfiguracao implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido p1 = new Pedido(null, LocalDateTime.parse("2024-07-02T10:15:00"), u1);
		Pedido p2 = new Pedido(null, LocalDateTime.parse("2024-07-02T20:45:00"), u2);
		Pedido p3 = new Pedido(null, LocalDateTime.parse("2024-07-03T15:30:20"), u3);
		Pedido p4 = new Pedido(null, LocalDateTime.parse("2024-07-04T06:00:00"), u2);
