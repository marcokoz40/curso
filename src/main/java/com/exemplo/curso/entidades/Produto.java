...
public class Produto implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "TabProdutosCategorias", joinColumns = @JoinColumn(name = "id_produto"), inverseJoinColumns = @JoinColumn(name = "id_categoria"))
	private Set<Categoria> conjuntoCategoria = new HashSet<>();
